...
variable "ec2_ami_id" {
  ...
  type        = string
  # Example: us-east-1 Amazon Linux 2 AMI (HVM), SSD Volume Type - consult AWS documentation for latest
  # You should parameterize this or use a data source to find the latest AMI.
  default     = "ami-0cff7528ff583bf9a" # This is an example for us-east-1, verify and update
}
